...
export const ProjectsList = [
  {
    ...
    description:
      "As a university student, a to-do list is an extremely effective time-management tool for keeping track of all my assignments. I had previously used various other to-do apps, but none seemed to have the exact functionality I was looking for. This is what sparked my idea for Octo-Do. Personally, I like to have an overall to-do list, and a daily to-do list on the same page so I can see what needs to be done that day and what is to come. \nWith this in mind, I built Octo-Do using React for the frontend, Node.js and Axios for the backend and MySQL for the database, all of which is hosted on Heroku. I also added Firebase user authentication so that each user's tasks stay separate. A big feature I wanted was the ability to drag-and-drop tasks from the overall to-do list to the daily to-do list, so I used react-dnd-beautiful library to achieve this. \nOverall, I am quite happy with the outcome of Octo-Do and will be using this as my main time management app for my upcoming academic semesters. In the future, I plan on adding new features and functionality to my app including more user flexibility in terms of customizing their app settings, and possibly different timeline and calendar views as well.",
    languages: [
      "JS",
      "React",
      "CSS",
